...
const ROIDS_NUM = 0; //starting number of asteroids
...
const LASER_SPD = 150; // Speed of laser in pixels per second
...
function update(){
    ...
    // Move ship and handle all associated collision detection
    moveShip();
